...
class ColorPickerBtn(tk.Canvas):
    def __init__(self, parent: tk.Tk, w: int = 30, h: int = 25, color_hex: str = "#00C487", pick_handler: callable | None = None) -> None:
    ...
    def handle_click(self, _ev: tk.Event) -> None:
